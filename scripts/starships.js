...
function starshipLoadInfo(pos){
    ...
    if(!pageOn){
        ...
        swapiModule.getStarship(pos, function(data){
            ...
            let shipClass = data.starship_class;
